...
class PrivateBankTestAlt {
    private PrivateBankAlt privateBank;

    @org.junit.jupiter.api.BeforeEach
    public void setup() {
        privateBank = new PrivateBankAlt("you_will_never_get_me", 0.5, 0.5);
    }
    ...
    @org.junit.jupiter.api.Test
    void testEquals() {
        PrivateBankAlt equalsBank = new PrivateBankAlt("you_will_never_get_me", 0.5, 0.5);
    ...
    void PrivateBank() {
        ...
        PrivateBankAlt copyBank = new PrivateBankAlt(privateBank);
